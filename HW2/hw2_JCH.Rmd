...
multinomial_regression_errors <- apply(multinomial_regression_prdct, 2, function(x) 1 - get_accuracy(x, y_test))
lda_accuracy <- get_accuracy(lda_prdct, y_test)

#how to go from dev ratio to R^2 for linear regression?
#https://stats.stackexchange.com/questions/46345/how-to-calculate-goodness-of-fit-in-glm-r/46358#46358
